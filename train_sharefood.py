...
def make_env(env_id, idx, capture_video, run_name, enable_empathy, weight_empathy, fsr):
    def thunk():
...
if __name__ == "__main__":
    ...
    os.makedirs("models/sharefood", exist_ok=True)

    s = datetime.now().strftime('%Y-%m-%d-%H-%M-%S')
    os.makedirs(f"models/sharefood/{s}", exist_ok=True)

    if args.enable_empathy is True and args.weight_empathy > 0:
        PATH = f"models/sharefood/{s}/agent_full_empathy.pt"
    elif args.enable_empathy is True and args.weight_empathy == 0:
        PATH = f"models/sharefood/{s}/agent_emp_channel.pt"
    elif args.enable_empathy is False and args.weight_empathy > 0:
        PATH = f"models/sharefood/{s}/agent_emp_reward.pt"
    elif args.enable_empathy is False and args.weight_empathy == 0:
        PATH = f"models/sharefood/{s}/agent_no_empathy.pt"
    else:
