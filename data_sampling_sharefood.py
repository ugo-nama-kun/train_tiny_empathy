            ...
            for n in tqdm(range(n_samples), desc=f"TYPE:{type_}, MODEL: {id_model+1}/{len(model_files[model_types[0]])} "):
                ...
                while global_step < max_time_steps:
                    ...
                    while global_step < max_time_steps:
                        ...
                        data[type_]["possessor_energy"][id_model][n][global_step] = int(infos[0][0]["energy"])
                        data[type_]["partner_energy"][id_model][n][global_step] = int(infos[1][0]["energy"])
