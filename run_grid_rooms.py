...
if __name__ == "__main__":
    # model_name = "models_grid/2024-05-18-04-13-46/agent_full_empathy.pt"
    # enable_empathy = True

    # model_name = "models_grid/2024-05-18-04-12-40/agent_emp_reward.pt"
    # enable_empathy = False

    # model_name = "models_grid/2024-05-18-04-13-47/agent_emp_channel.pt"
    # enable_empathy = True

    model_name = "models_grid/2024-05-18-04-13-46/agent_no_empathy.pt"
    enable_empathy = False

    seed = 10
    run_name = f"{'GridRooms-v0'}__{seed}__{int(time.time())}"
    capture_video = False
    ...
    envs = gym.vector.SyncVectorEnv(
        [make_env("tiny_empathy/GridRooms-v0", i, capture_video, run_name, enable_empathy, weight_empathy) for i in range(1)],
    )
